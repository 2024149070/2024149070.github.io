...
async function initShader() {
    const vertexShaderSource = await readShaderFile('shVert05.glsl');
    const fragmentShaderSource = await readShaderFile('shFrag05.glsl');
...
function render() {
    ...
    cameraCircleHeight = 5 + 5 * Math.sin(glMatrix.toRadian(45.*elapsedTime)) ; 
